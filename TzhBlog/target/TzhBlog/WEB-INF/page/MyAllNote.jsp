                        ...
                        <c:if test="${is_zero=='1'}">
                            <table class="table table-hover table-responsive table-striped table-bordered"
                                ...
                                <c:forEach items="${currentPageUsers}" var="li">
                                    <tr id="${li.id}">
                                        <td>${li.note_title}</td>
                                        <td>${li.note_mark},${li.note_markt}</td>
                                        <td><fmt:formatDate type="both" value="${li.write_time}"/></td>
                                        <td>
                                            <a href="<%=basePath%>/Blog/Mynote?id=${li.id}">查看</a>
                            ...
                            <div class="text-center" style="margin-top: 0px">
                                <nav>
                                    <ul class="pagination">
                                        ...
                                        <li><a href="<c:url value="${basePath}/Blog/MyAllNote?page=1"/>">首页</a>
                                        </li>

                                        <li>
                                            <a href="<c:url value="${basePath}/Blog/MyAllNote?page=${page-1>1?page-1:1}"/>">&laquo;</a>
                                        </li>
                                        ...
                                        <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                                            ...
                                            <li class="${active}"><a
                                                    href="<c:url value="${basePath}/Blog/MyAllNote?page=${loop.index}"/>">${loop.index}</a>
                                            </li>

                                        </c:forEach>
                                        <li>
                                            <a href="<c:url value="${basePath}/Blog/MyAllNote?page=${page+1<totalPages?page+1:totalPages}"/>">&raquo;</a>
                                        </li>
                                        <li>
                                            <a href="<c:url value="${basePath}/Blog/MyAllNote?page=${totalPages}"/>">尾页</a>
                                        </li>
                                    </ul>
