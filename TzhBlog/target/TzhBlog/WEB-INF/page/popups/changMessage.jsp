...
<script src="<%=basePath%>/layer/layer.js"></script>
    <div style="padding-left: 0%;padding-top:0px;">
        <p><span>昵称：</span>
            <input type="text" autocomplete="off" minlength="2" maxlength="20" value="${nickname}" id="name">
        </p>
        <p><span>实名：</span>
        ...
        <div style="width: 400px;height: 100px;" >
            ...
            <div style="width: 350px;height: 100px;float: left;margin-top: 20px;">
                <textarea maxlength="300" placeholder="300字以内" style="width: 300px;height: 100px;" id="remark"></textarea>
            </div>
        </div>
