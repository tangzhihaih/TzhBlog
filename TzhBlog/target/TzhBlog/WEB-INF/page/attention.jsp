...
<div >
    <div class="col-sm-3 col-md-2 sidebar" style="margin-left: 12%;background-color: white;">
        <ul class="nav nav-sidebar">
            ...
            <li><a href="<%=basePath%>/Blog/fans?page=1">我的关注</a></li>
    ...
    <div style="margin-left: 28.7%;height: 70%;margin-right: 10%;background-color: white"><%--/**/#f5f5f5--%>
        <div style=" border-bottom: 0.3px solid  #000 ;width: 100%;height: 4%">
            <div style="float: left;width: 30%;height: 100%">
                <h4 style="padding-left: 10%;padding-top: 1%;">我的关注</h4>
                <br/>
            </div>
                            ...
                            <table class="table table-hover table-responsive table-striped table-bordered"
                                ...
                                <c:forEach items="${currentPageUsers}" var="li">
                                    <tr id="${li.user.username}">
                                        <td><img src="<%=basePath%>/photo/${li.img.img_name}" class="layui-nav-img">
                                            <a href="<%=basePath%>/Blog/view_User?username=${li.user.username}&page=1">${li.user.nickname}</a></td>
                                        <td style="text-decoration: none">
                                            <c:if test="${li.type=='0'}">
                                                <a id="follow_again"  href="<%=basePath%>/Blog/follow_again?username=${li.user.username}&page=${page}"
                                                   class="layui-btn layui-btn-lg layui-btn-primary layui-btn-radius">关注</a>
                                            </c:if>
                                            <c:if test="${li.type=='1'}">
                                                <a id="cancel_follow" href="<%=basePath%>/Blog/att_canfollow?username=${li.user.username}&page=${page}"
                                                   class="layui-btn layui-btn-lg layui-btn-primary layui-btn-radius">取消关注</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
